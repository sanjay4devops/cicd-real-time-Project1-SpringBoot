node {
    ...
    stage('Deploy Docker Image and login'){
      ...
      echo "Docker Image Tag Name: ${dockerImageTag}"
        ...
        sh "docker images"
        sh "docker login -u sanjay4devops -p srt@200bong" // put PWD
	...
	//sh "read imageid"
	   sh "docker tag a272caa53a56  sanjay4devops/cicd" //must change your name and tag no
        sh "docker push   sanjay4devops/cicd"
  }
}
